...
**WISC Lab guide to the hand-correction of force-aligned textgrids**
...
![Recording of “the sign says keep out” in Praat.](alignmentGuide/media/image4.png){#fig-1 width="60%"}
...
We can open these textgrids along with the audio file in a program called **Praat** (Dutch for “speech”, sounds like “praht” - /pra:t/). When the textgrids and audio files are paired together in Praat, it is now easier and quicker for us to make measurements because we have labels for each word and sound, as well as the time intervals during which these events occur.
...
@fig-3 shows a textgrid prior to hand-correction, and @fig-4 shows the same textgrid but with black and gold squares overlaid on the image to show where the word boundaries actually are. @fig-5 shows what the textgrid looks like after hand-correction.

![Force-aligned textgrid of cowboy boots that has not yet been hand-corrected. The boundaries for cowboy were placed too soon, and boundaries for boots include the -boy part of cowboy.](alignmentGuide/media/image6.png){#fig-3 width="60%"}

![Force-aligned textgrid of cowboy boots that has not yet been hand-corrected. Black and gold squares show where the words actually occur.](alignmentGuide/media/image7.png){#fig-4 width="60%"}

![Hand-corrected textgrid of cowboy boots. We can now see how the boundaries in the textgrid line up with where the box shapes indicated that the word were.](alignmentGuide/media/image8.png){#fig-5 width="60%"}

### c. phonetic alphabets {#c.-phonetic-alphabets}

This guide makes use of two different phonetic alphabets. The first is the International Phonetic Alphabet which is described [here](https://www.internationalphoneticassociation.org/content/full-ipa-chart) and will be notated using conventional forward slashes as in /t/ or /u/. The second is the ARPAbet symbol set developed by the Advanced Research Projects Agency. This is the alphabet seen in example alignments, as MFA alignments performed in the WISC Lab make use of the [CMU pronunciation dictionary](http://www.speech.cs.cmu.edu/cgi-bin/cmudict). Symbols which use this alphabet will be denoted in all-caps as in T or UW. A detailed description of each of the 39 phonemes included in the ARPAbet symbol set can be found on [Wikipedia](https://en.wikipedia.org/wiki/ARPABET). It is important to note that this symbol set makes use of numbers to denote tone. Furthermore, the alignments performed in the WISC Lab and any alignments using the CMU dictionary are based on North American pronunciations. Additional considerations for the use of dictionaries outside of these pronunciations are not considered at this time.

### d. Montreal Forced Aligner {#d.-montreal-forced-aligner}
...
![Initial voiceless stop consonant boundary placement in context.](alignmentGuide/media/image28.png){#fig-12 width="60%"}

Zoomed in:\

![Initial stop consonant boundary placement zoomed in.](alignmentGuide/media/image29.png){#fig-13 width="70%"}
...
![Voiced initial stop with no prevoicing (this is typical).](alignmentGuide/media/image31.png){#fig-15 width="60%"}

Zoomed in:\

![Voiced initial stop with no prevoicing zoomed in.](alignmentGuide/media/image32.png){#fig-16 width="70%"}
...
![Initial fricative boundary placement in context.](alignmentGuide/media/image33.png){#fig-17 width="60%"}

Zoomed in:\

![Initial fricative boundary placement zoomed in.](alignmentGuide/media/image34.png){#fig-18 width="70%"}
...
![Initial nasal boundary placement in context.](alignmentGuide/media/image35.png){#fig-19 width="60%"}
...
![Initial nasal boundary placement zoomed in.](alignmentGuide/media/image36.png){#fig-20 width="70%"}
...
![Initial L boundary placement in context.](alignmentGuide/media/image37.png){#fig-21 width="60%"}

Zoomed in:\

![Initial L boundary placement zoomed in.](alignmentGuide/media/image38.png){#fig-22 width="70%"}
...
![Initial R boundary placement in context.](alignmentGuide/media/image39.png){#fig-23 width="60%"}

Zoomed in:\

![Initial R boundary placement zoomed in.](alignmentGuide/media/image40.png){#fig-24 width="70%"}
...
![Y in the word "new" should be deleted.](alignmentGuide/media/image47.png){#fig-31 width="65%"}

What this looks like after hand-correction:\

!["new" following deletion of Y.](alignmentGuide/media/image48.png){#fig-32 width="65%"}
...
![Initial vowel boundary placement in context.](alignmentGuide/media/image49.png){#fig-33 width="60%"}

Zoomed in:\

![Initial vowel boundary placement zoomed in.](alignmentGuide/media/image50.png){#fig-34 width="70%"}

#### Word-initial glides – W and Y {#word-initial-glides-w-y}
...
![Initial glide boundary placement in context.](alignmentGuide/media/image51.png){#fig-35 width="60%"}

Zoomed in:\

![Initial glide boundary placement zoomed in.](alignmentGuide/media/image52.png){#fig-36 width="70%"}
...
![Consonant to vowel transition boundary placement in context.](alignmentGuide/media/image55.png){#fig-39 width="60%"}

What this looks like zoomed in:\

![Consonant to vowel transition boundary placement zoomed in.](alignmentGuide/media/image56.png){#fig-40 width="60%"}
...
![Vowel starts before phonation, viewed in context.](alignmentGuide/media/image60.png){#fig-44 width="60%"}

Zoomed in:\

![Vowel starts before phonation, zoomed in.](alignmentGuide/media/image61.png){#fig-45 width="60%"}
...
![Voiceless vowel in “potato," viewed in context.](alignmentGuide/media/image62.png){#fig-46 width="60%"}

Zoomed in:\

![Voiceless vowel in “potato," zoomed in.](alignmentGuide/media/image63.png){#fig-47 width="60%"}
...
![Stop to fricative boundary in "boots," viewed in context.](alignmentGuide/media/image66.png){#fig-50 width="60%"}

Zoomed in:\

![Stop to fricative boundary in "boots," zoomed in.](alignmentGuide/media/image67.png){#fig-51 width="60%"}
...
![When to start HH in consonant-to-consonant transition, viewed in context.](alignmentGuide/media/image68.png){#fig-52 width="60%"}

Zoomed in:\

![D\|HH boundary, zoomed in.](alignmentGuide/media/image69.png){#fig-53 width="60%"}
...
![Syllabic R.](alignmentGuide/media/image110.png){#fig-95 width="60%"}
